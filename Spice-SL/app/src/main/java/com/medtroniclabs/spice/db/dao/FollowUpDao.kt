...
interface FollowUpDao {
    ...
    @Query("SELECT fu.id, hhm.id AS localPatientId, hhm.name, fu.patientId, hhm.date_of_birth as dateOfBirth, hhm.gender, fu.reason, fu.patientStatus, ve.name AS village, hh.name AS householdName, hh.landmark, fu.type, fu.encounterType, fu.attempts AS remainingRetryAttempt, fu.nextVisitDate, fu.encounterDate " +
