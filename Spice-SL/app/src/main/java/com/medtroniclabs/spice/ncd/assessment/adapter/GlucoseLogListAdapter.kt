...
import com.medtroniclabs.spice.databinding.ListItemGlucoseLogBinding
...
class GlucoseLogListAdapter(private val glucoseLogs: ArrayList<GlucoseLogList>) :
    ...
    override fun onBindViewHolder(
        ...
        val glucoseValue =
            if ((glucoseLog.glucoseValue ?: 0.0) > 0) glucoseLog.glucoseValue.toString() else ""
        ...
        val hbA1cValue =
            if ((glucoseLog.hba1c ?: 0.0) > 0) glucoseLog.hba1c.toString() else ""
