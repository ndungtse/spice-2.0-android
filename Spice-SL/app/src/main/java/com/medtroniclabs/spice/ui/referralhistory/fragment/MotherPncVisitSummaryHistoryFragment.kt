...
class MotherPncVisitSummaryHistoryFragment : BaseFragment() {
    ...
    companion object {
        ...
        fun newInstance(): MotherPncVisitSummaryHistoryFragment {
            return MotherPncVisitSummaryHistoryFragment()
        }
    }
}