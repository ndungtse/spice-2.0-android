...
class HouseholdListAdapter(
    ...
    private val houseHoldList: ArrayList<HouseholdListModel>
    ...
    override fun onBindViewHolder(
        ...
        holder.binding.tvCardHouseholdName.text = item.householdName
        holder.binding.tvHouseholdNo.text = item.householdNo.toString()
        val membersText = holder.binding.root.context.getString(R.string.people_registered, item.noOfPeopleRegistered, item.noOfPeople)
