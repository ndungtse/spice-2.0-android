...
import org.medtroniclabs.uhis.data.offlinesync.model.Prescription
...
class TBTreatmentFragment : BaseFragment() {
    ...
    private fun createTreatmentDetailsCardView(listSummaryData: List<AssessmentSummaryModel>?) {
