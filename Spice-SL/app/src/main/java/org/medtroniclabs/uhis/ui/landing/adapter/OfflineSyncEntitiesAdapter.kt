...
import org.medtroniclabs.uhis.databinding.RowOfflineEntityDetailsBinding
...
class OfflineSyncEntitiesAdapter :
    ...
    override fun onBindViewHolder(
        holder: OfflineSyncEntitiesViewHolder,
        position: Int,
    ) {
        val item = items[position]
        holder.binding.tvLabel.text = holder.binding.root.context
